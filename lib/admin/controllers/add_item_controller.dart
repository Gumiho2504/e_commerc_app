...
final addItemProvider = StateNotifierProvider<AddItemNotifier, ItemState>((
  ref,
) {
  ref.keepAlive();
...
class AddItemNotifier extends StateNotifier<ItemState> {
  AddItemNotifier()
    : super(ItemState(null, false, null, [], [], [], false, null)) {
    fetctCategory();
  }
